	                ...
	                items: [
	                    {
                            ...
                            //labelWidth: '30%',
                            options: [
                                {text: 'Đăng ký thông tin cá nhân cho thuê bao mới',  value: '1'},
                                {text: 'Thay đổi/cập nhật lại thông tin thuê bao', value: '0'},
...
//						debugger
	...
	activate : function() {
		this.down('#5friends').setHidden(false);
		this.down('#friend1').setHidden(false);
		this.down('#friend2').setHidden(false);
		this.down('#friend3').setHidden(false);
		this.down('#friend4').setHidden(false);
		this.down('#friend5').setHidden(false);
		this.down('#active_date').setHidden(false);
		this.down('#recent_charge_date').setHidden(false);
		this.down('#recent_charge_value').setHidden(false);
		this.down('#recent_charge_date').setHidden(false);
		this.down('#comment').setHidden(false);
		this.down('#otp').setHidden(false);
		this.down('#otpBtn').setHidden(false);
//		this.down('#reCaptcha').setHidden(true);
		this.down('#serialsim').setHidden(true);
		this.down('#simcode').setHidden(true);
